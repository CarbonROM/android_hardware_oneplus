...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private boolean mHasSetupCompleted;
    ...
    public KeyHandler(Context context) {
        ...
        mHasSetupCompleted = Settings.Secure.getInt(mContext.getContentResolver(),
    ...
    public KeyEvent handleKeyEvent(KeyEvent event) {
        ...
        if (!mHasSetupCompleted || keyCode == null || event.getAction() != KeyEvent.ACTION_DOWN) {
            return event;
        }
